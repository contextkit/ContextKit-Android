...
import it.cnr.iit.ck.sensing.controllers.CallsController;
import it.cnr.iit.ck.sensing.controllers.ContactsController;
import it.cnr.iit.ck.sensing.model.Call;
...
class CallsProbe extends OnEventProbe {
    ...
    public void onFirstRun() {
        logOnFile(CallsController.getAllCalls(getContext()));
    }
    ...
    private void onNewCall(String number, boolean incoming){
        ...
        logOnFile(new Call(new Date().getTime(), name, number, incoming));
